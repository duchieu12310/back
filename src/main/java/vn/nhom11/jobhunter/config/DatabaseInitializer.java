package vn.nhom11.jobhunter.config;
...
import vn.nhom11.jobhunter.util.constant.GenderEnum;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            arr.add(new Permission("Get jobs by created username", "/api/v1/jobs/by-created/{username}", "GET",
                    "JOBS"));
            ...
            arr.add(new Permission("Create company registration", "/api/v1/company-registrations", "POST",
                    "COMPANY_REGISTRATIONS"));
            arr.add(new Permission("View company registrations", "/api/v1/company-registrations", "GET",
                    "COMPANY_REGISTRATIONS"));
            arr.add(new Permission("Update company registration status",
